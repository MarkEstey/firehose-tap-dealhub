...
class Quotes(DealHubStream):
    ...
    schema = PropertiesList(
        ...
        Property('line_items', ArrayType(ObjectType(
            ...
            Property('product_factors', ObjectType(), description='List of all products factors (e.g. quantity, duration, etc) relevant for specific line item'),
            Property('attributes', ObjectType(), description='List of line item attributes (aka proposal attributes), which differ per each SKU.'),
